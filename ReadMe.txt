...
Frameworks:		Java, JAXB, MOXy, JUnit, freemarker. 
IDE:			NetBeans IDE
Application Servers	N/A
JDK:			Java 7

(This is a Spin off of the original and simpler Travelogue project. This project will use freemarker to create the static HTMLs)
